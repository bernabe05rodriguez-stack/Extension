...
// TODO ver donde se usa y borrar
// AWS APIs / URLs
// let AWS_API = {
//   PLAN_FETCH: "",
//   GET_CONFIG_DATA: "",
...
let HELP_MESSAGES = {
  REQUEST_CHAT_SUPPORT_BASIC:
    "Hi, I would like to request chat support for Pro Sender Basic.",
  REQUEST_CHAT_SUPPORT_ADVANCE:
    "Hi, I would like to request chat support for Pro Sender Advance.",
  REQUEST_ZOOM_SUPPORT_BASIC:
    "Hi, I would like to request video call support for Pro Sender Basic.",
  REQUEST_ZOOM_SUPPORT_ADVANCE:
    "Hi, I would like to request video call support for Pro Sender Advance.",
  REQUEST_CALL_SUPPORT_ADVANCE:
    "Hi, I would like to request call support for Pro Sender Advance.",
  REQUEST_CALL_SUPPORT_BASIC:
    "Hi, I would like to request call support for Pro Sender Basic.",
